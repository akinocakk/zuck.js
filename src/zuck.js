    ...
    var ZuckJS = function ZuckJS (timeline, options) {
      ...
      var ZuckModal = function ZuckModal () {
        ...
        var createStoryViewer = function createStoryViewer (storyData, className, forcePlay) {
          ...
          each(get(storyData, 'items'), function (i, item) {
            ...
            htmlItems += '<div data-time="'.concat(get(item, 'time'), '" data-type="').concat(get(item, 'type'), '"').concat(commonAttrs, ' class="item ').concat(seenClass, ' ').concat(currentItem === i ? 'active' : '', '">').concat(renderCallback(item, ''.concat(get(item, 'type') === 'video' ? '<video class="media" muted webkit-playsinline playsinline preload="auto" src="'.concat(get(item, 'src'), '" ').concat(get(item, 'type'), '></video>') : '<img class="media" src="'.concat(get(item, 'src'), '" ').concat(get(item, 'type'), '>'), '').concat(get(item, 'link') ? '<div class="ym-story-footer" data-url="' + get(item, 'link') + '"><i class="fas fa-chevron-up"></i><div><div class="tip link" data-url="' + get(item, 'link') + '">'.concat(!linkText || linkText === '' ? option('language', 'visitLink') : linkText, '</div></div><div class="ym-story-footer-alt"></div>') : '', '')), '</div></div>');
          });
      ...
      zuck.changedHook = function () {
        ...
        if (pp.classList.contains('fa-play')) {
          ...
          document.querySelector('.story-viewer.viewing').classList.remove('paused');
        }
